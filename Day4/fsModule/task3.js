...
/**
 * To test this script Run this Script first
 * Then First add some text in any file in the Directory,
 * then second delete any file
 * then third add any file
 * every event should console 
 */